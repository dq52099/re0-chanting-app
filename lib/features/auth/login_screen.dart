...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Future<void> _checkSavedAuth() async {
    ...
    try {
      ...
      ref.read(manaProvider.notifier).state = auth['quota_summary'];
      if (mounted) {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      ref.read(manaProvider.notifier).state = res['user']['quota_summary'];
      ...
      body: Center(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              const Icon(Icons.auto_awesome, size: 80, color: Re0Theme.crystalBlue),
              const SizedBox(height: 20),
              const Text('连接至圣域网关', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
